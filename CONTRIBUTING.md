...
Thank you for investing your time in contributing to LLMFlow project! 

Read our [Code of Coduct](./CODE_OF_CONDUCT.md) to keep our community approachable and respectable.

This guide details how to use issues and pull requests to improve LLMFlow project.

## General Guidelines

### Getting involved

LLMFlow has an active community of developers. Here’s how to get involved with the LLMFlow community:
...
If you spot a problem with the problem, [search if an issue already exists](https://github.com/LLMFlow/LLMFlow/issues). If a related issue doesn't exist, you can open a new issue using [issue template](https://github.com/LLMFlow/LLMFlow/issues/new/choose). 

### Solve an issue

LLMFlow has subproject and each of them may have different development and testing procedure. Please check `DEVELOPMENT.md` in sub folder to get familar with running and testing codes.
